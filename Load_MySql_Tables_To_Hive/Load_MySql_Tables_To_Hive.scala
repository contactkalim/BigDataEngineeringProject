...
object Load_MySql_Tables_To_Hive {
  def main(args: Array[String]) {
	...
	val calendar_details_df = spark.read.format("jdbc").option("url", "jdbc:mysql://dbserver.edu.cloudlab.com/labuser_database").option("driver", "com.mysql.jdbc.Driver")
	.option("dbtable", "edureka_766323_futurecart_calendar_details").option("user", "edu_labuser").option("password", "edureka").load()
	...
	calendar_details_df_1.write.mode("overwrite").partitionBy("create_date").format("orc").saveAsTable("edureka_766323.dim_futurecart_calendar")

	val call_center_details_df = spark.read.format("jdbc").option("url", "jdbc:mysql://dbserver.edu.cloudlab.com/labuser_database").option("driver", "com.mysql.jdbc.Driver")
	.option("dbtable", "edureka_766323_futurecart_call_center_details").option("user", "edu_labuser").option("password", "edureka").load()
	...
	call_center_details_df_1.write.mode("overwrite").partitionBy("create_date").format("orc").saveAsTable("edureka_766323.dim_futurecart_call_center")
	...
	case_category_details_df_1.write.mode("overwrite").partitionBy("create_date").format("orc").saveAsTable("edureka_766323.dim_futurecart_case_category")

	val case_country_details_df = spark.read.format("jdbc").option("url", "jdbc:mysql://dbserver.edu.cloudlab.com/labuser_database").option("driver", "com.mysql.jdbc.Driver")
	.option("dbtable", "edureka_766323_futurecart_case_country_details").option("user", "edu_labuser").option("password", "edureka").load()
	...
	case_country_details_df_1.write.mode("overwrite").partitionBy("create_date").format("orc").saveAsTable("edureka_766323.dim_futurecart_country")
	...
	case_priority_details_df_1.write.mode("overwrite").partitionBy("create_date").format("orc").saveAsTable("edureka_766323.dim_futurecart_case_priority")

	val employee_details_df = spark.read.format("jdbc").option("url", "jdbc:mysql://dbserver.edu.cloudlab.com/labuser_database").option("driver", "com.mysql.jdbc.Driver")
	.option("dbtable", "edureka_766323_futurecart_employee_details").option("user", "edu_labuser").option("password", "edureka").load()
	...
	employee_details_df_1.write.mode("overwrite").partitionBy("hire_date").format("orc").saveAsTable("edureka_766323.dim_futurecart_employee")

	val product_details_df = spark.read.format("jdbc").option("url", "jdbc:mysql://dbserver.edu.cloudlab.com/labuser_database").option("driver", "com.mysql.jdbc.Driver")
	.option("dbtable", "edureka_766323_futurecart_product_details").option("user", "edu_labuser").option("password", "edureka").load()
	...
	product_details_df_1.write.mode("overwrite").partitionBy("create_date").format("orc").saveAsTable("edureka_766323.dim_futurecart_product")

	val survey_question_details_df = spark.read.format("jdbc").option("url", "jdbc:mysql://dbserver.edu.cloudlab.com/labuser_database").option("driver", "com.mysql.jdbc.Driver")
	.option("dbtable", "edureka_766323_futurecart_survey_question_details").option("user", "edu_labuser").option("password", "edureka").load()
	...
	survey_question_details_df_1.write.mode("overwrite").partitionBy("create_date").format("orc").saveAsTable("edureka_766323.dim_futurecart_questions")
